  ...
  private class TestAsyncTask extends AsyncTask<Void, String, Void> {
    ...
    protected Void doInBackground(Void... paramses) {
      try {
        ...
        final String remoteDevice = "98:D3:31:B2:13:9A";
     ...
     */
        ...
        bitalino = new BITalinoDevice(10, new int[]{0, 1, 2, 3, 4, 5});
    ...
    protected void onProgressUpdate(String... values) {
      ...
      private String getNumbers(BITalinoFrame frame) {
         return String.valueOf(frame.getAnalog(1));
      };
